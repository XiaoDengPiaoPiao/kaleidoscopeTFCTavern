...
public class ModFluids {
    ...
    public static void register(RegisterEvent event) {
        ...
        event.register(ForgeRegistries.Keys.FLUIDS, helper -> {
            ForgeFlowingFluid.Properties purpleGrapeJuice = new ForgeFlowingFluid.Properties(PURPLE_GRAPE_JUICE_TYPE, PURPLE_GRAPE_JUICE, FLOWING_PURPLE_GRAPE_JUICE)
                    .bucket(ModItems.PURPLE_GRAPE_BUCKET)
                    .block(ModBlocks.PURPLE_GRAPE_JUICE_BLOCK);
            ForgeFlowingFluid.Properties redGrapeJuice = new ForgeFlowingFluid.Properties(RED_GRAPE_JUICE_TYPE, RED_GRAPE_JUICE, FLOWING_RED_GRAPE_JUICE)
                    .bucket(ModItems.RED_GRAPE_BUCKET)
                    .block(ModBlocks.RED_GRAPE_JUICE_BLOCK);
            ForgeFlowingFluid.Properties whiteGrapeJuice = new ForgeFlowingFluid.Properties(WHITE_GRAPE_JUICE_TYPE, WHITE_GRAPE_JUICE, FLOWING_WHITE_GRAPE_JUICE)
                    .bucket(ModItems.WHITE_GRAPE_BUCKET)
                    .block(ModBlocks.WHITE_GRAPE_JUICE_BLOCK);
            ForgeFlowingFluid.Properties greenGrapeJuice = new ForgeFlowingFluid.Properties(GREEN_GRAPE_JUICE_TYPE, GREEN_GRAPE_JUICE, FLOWING_GREEN_GRAPE_JUICE)
                    .bucket(ModItems.GREEN_GRAPE_BUCKET)
                    .block(ModBlocks.GREEN_GRAPE_JUICE_BLOCK);
