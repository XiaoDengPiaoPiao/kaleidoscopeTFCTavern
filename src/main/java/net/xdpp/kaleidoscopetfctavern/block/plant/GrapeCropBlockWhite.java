 ...
 * 白葡萄作物方块
 * <p>
 * 生长在TFC兼容葡萄藤藤架下方的白葡萄作物
 * 支持剪刀收割，有5个生长阶段
 * 支持TFC气候检查，气候不适时会自动销毁
 */
@SuppressWarnings("deprecation")
public class GrapeCropBlockWhite extends BaseGrapeCropBlock {
    ...
    public GrapeCropBlockWhite() {
        super(() -> ModItems.GRAPE_WHITE.get());
    }

    /**
     * 获取克隆物品栈
     * <p>
     * 当玩家用鼠标中键点击方块时返回对应的白葡萄物品
     * 
     * @param state 方块状态
     * @param target 点击目标
     * @param level 世界
